...
export const defaultLayout = (
    ...
    <html class="default" lang={context.options.getValue("lang")} data-base={context.relativeURL("./")}>
        <head>
            ...
            <script>
                <JSX.Raw html='const saved=localStorage.getItem("tsd-theme")||"os";document.documentElement.dataset.theme=saved=="os"?(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"):saved' />
            </script>
